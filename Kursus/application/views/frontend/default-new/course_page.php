                        ...
                        <div class="card-img">
                            <div class="courses-card-image">
                                <div class="card-video-icon" onclick="lesson_preview('<?php echo site_url('home/course_preview/' . $course_details['id']); ?>', '<?php echo get_phrase($course_details['title']) ?>')">
                                    <!--tombol card video sudah diilangkan-->
                                </div>
...
$start_month = $course_details['start_month'] ?? 1;
$duration = $course_details['expiry_period'];
$end_month = ($start_month + $duration - 1) % 12;
$end_month = $end_month == 0 ? 12 : $end_month;
?>

<?php if ($duration <= 0) : ?>
    <?php echo get_phrase('Lifetime') ?>
<?php else : ?>
    <?= $bulan[$start_month] . ' – ' . $bulan[$end_month]; ?>
<?php endif; ?>
